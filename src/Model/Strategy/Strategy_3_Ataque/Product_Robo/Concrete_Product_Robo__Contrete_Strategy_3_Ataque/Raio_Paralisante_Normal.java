...
public class Raio_Paralisante_Normal extends Arma_Do_Robo {

    public Raio_Paralisante_Normal(Personagem atacante) {
        super(atacante);
        setDanoAtaque(10);
    }
    ...
    public void atacar(Personagem atacado) {
        ...
        if (validar(atacado)) {
            ...
            //Atribui o ataque e os golpes (ÚTIL SOMENTE PARA A VIEW (DisplayInformacoesPersonagem) PRESENTE NA CLASSE PERSONAGEM
            //e NA VIEW PRESENTE NA CLASSE ATAQUE (DisplayProcura)
