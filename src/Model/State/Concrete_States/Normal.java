...
public class Normal extends PersonagemState {
    ...
    public Normal(Personagem personagem) {
        ...
        getPersonagem().setCorrida(new Model.Strategy.Strategy_2_Corrida.Concrete_Strategy_2_Corrida.Normal(getPersonagem()));
        getPersonagem().setPulo(new Model.Strategy.Strategy_1_Pulo.Concrete_Strategy_1_Pulo.Normal(getPersonagem()));
