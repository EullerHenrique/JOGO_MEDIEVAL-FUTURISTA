...
import Model.Strategy.Strategy_1_Pulo.Concrete_Strategy_1_Pulo.Alto;
import Model.Strategy.Strategy_2_Corrida.Concrete_Strategy_2_Corrida.Rapida;
...
public class Forte extends PersonagemState {
    ...
    public Forte(Personagem personagem) {
        ...
        getPersonagem().setPulo(new Alto(getPersonagem()));
