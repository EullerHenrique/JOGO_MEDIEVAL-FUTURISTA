...
import Model.Strategy.Strategy_1_Pulo.Concrete_Strategy_1_Pulo.Baixo;
import Model.Strategy.Strategy_2_Corrida.Concrete_Strategy_2_Corrida.Devagar;
...
public class Fraco extends PersonagemState {
    ...
    public Fraco(Personagem personagem) {
        ...
        getPersonagem().setCorrida(new Devagar(getPersonagem()));
        getPersonagem().setPulo(new Baixo(getPersonagem()));
    ...
    public void verificarAlteracaoEstado(){
        ...
        if(getPersonagem().getLife() > (30*getPersonagem().getLifeMaxima()/100)){
            ...
            getPersonagem().setPersonagemState(new Normal(getPersonagem()));
            getPersonagem().getPersonagemState().verificarAlteracaoEstado();
        }
        //Morto
        else if(getPersonagem().getLife() <= 0){
            getPersonagem().setPersonagemState(new Morto(getPersonagem()));
        }
